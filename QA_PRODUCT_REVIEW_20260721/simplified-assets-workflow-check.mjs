...
check("ICP Brief ends with one clear Target List CTA", (source.match(/<h2>Next: Build Your Target List<\/h2>/g) || []).length >= 2 && (source.match(/>Build Your Target List<\/a>/g) || []).length >= 2 && /Add companies that match the fit criteria and observable signals above/.test(source));
