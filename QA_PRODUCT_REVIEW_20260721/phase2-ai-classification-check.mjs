...
try {
  ...
  const checks = {
    ...
    postRevenueProofUsesAdaptiveCoaching: config.provenCustomerOutcomes.mode === "adaptive_coaching" && !config.preMessageProofPoint,
    ...
    preRevenueProofUsesRecommendationDropdownOnly: !preMotion.help.some((item) => item.fieldId === "preMessageProofPoint"),
