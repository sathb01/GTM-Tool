      ...
      content: [
        {
          ...
          fields: [
            { id: "customerContextStarter", label: "Describe the customer, user, or buyer you most want to reach", type: "textarea", full: true, hint: "Include who they are, the situation they are in, what they are trying to do, what is difficult today, and details that would help find more of them. This is source context for the structured ICP questions below.", placeholder: "Add a detailed customer description.", example: "People or organizations responsible for a specific job, activity, or outcome who are trying to achieve a better result but currently struggle with a clear problem. They can be identified by observable characteristics such as their situation, behavior, role, location, company type, or buying need." }
          ]
        },
        {
          ...
          tables: [
            {
              ...
              columns: [
                ...
                { id: "segmentType", label: "What kind of customer is this?", type: "multiSelectDropdown", group: "Segment", otherLabel: "Define other segment type", requireOther: true, options: PRE_REVENUE_CUSTOMER_TYPE_OPTIONS },
                { id: "segmentTypeUnknown", label: "If you do not know the customer type yet, who would use, buy, recommend, approve, or carry the product?", type: "text", group: "Segment", full: true, showWhen: { field: "segmentType", contains: "I don't know yet" }, placeholder: "Example: end user, gift buyer, store owner, retailer buyer, distributor, influencer, community leader." },
                ...
                { id: "specificUseCaseDefinition", label: "Briefly define the specific use case, job, task, or occasion", type: "textarea", group: "Segment", full: true, required: true, showWhen: { field: "description", contains: "Specific use case, job, task, or occasion" }, hint: "Describe who is in the situation, what they are trying to do, and what better outcome they want. This becomes the plain-language use case in the ICP Brief.", placeholder: "Example: People handling a recurring task who need a faster, safer, simpler, or more reliable way to complete it." },
      ...
      content: [
        {
          ...
          fields: [
            { id: "customerContextStarter", label: "Describe the customer, user, or buyer you most want to reach", type: "textarea", full: true, hint: "Include who they are, the situation they are in, what they are trying to accomplish, what is difficult today, and details that would help find more of them.", placeholder: "Add a detailed customer description.", example: "People or organizations responsible for a specific job, activity, or outcome who are trying to achieve a better result but currently struggle with a clear problem. They can be identified by observable characteristics such as their situation, behavior, role, location, company type, or buying need." }
          ]
        },
        {
          ...
          tables: [
            {
              ...
              columns: [
                ...
                { id: "primaryBuyer", label: "Who would this motion need to reach first?", type: "select", options: ["", "Economic Buyer", "Executive Sponsor", "Champion", "Day-to-Day User", "Implementation Owner", "Finance / Procurement", "Technical / Security Reviewer", "Legal", "Operations", "Customer Success / Support", "Likely Blocker", "External Advisor / Consultant", "Board / Investor", "Other", "Not sure yet"] },
                { id: "buyingCommitteeRoles", label: "Who else is usually involved in this revenue motion?", type: "multiSelectDropdown", hint: "Select other stakeholders who approve, influence, implement, use, review risk, or block this motion.", options: ["Economic Buyer", "Executive Sponsor", "Champion", "Day-to-Day User", "Implementation Owner", "Finance / Procurement", "Technical / Security Reviewer", "Legal", "Operations", "Customer Success / Support", "Likely Blocker", "External Advisor / Consultant", "Board / Investor", "Other", "Not sure yet"] },
