          ...
          tables: [
            {
              ...
              columns: [
                ...
                { id: "validationRecommendationReview", label: "How should the tool handle the 30-day validation path?", type: "select", group: "Validation", full: true, options: ["Use the recommended test", "I want to revise the recommended test", "Not sure yet"], hint: "The report generates a route-specific test from this segment, product stage, current access, available time, and the commitment being tested." },
