  ...
  sections: [
    {
      ...
      description: "Add only what you know. Choose Not sure yet when the answer is unknown, choose Not applicable only when the question truly does not apply, and do not guess.",
      ...
      fields: [
        ...
        { id: "reviewPeriod", label: "Report Time Period", type: "select", hideForPreRevenue: true, options: ["Last 90 days", "Last 6 months", "Last 12 months", "Current quarter", "Current fiscal year", "Current Calendar Year", "Custom Date Range"] },
        { id: "reportStartDate", label: "Custom start date", type: "text", hideForPreRevenue: true, placeholder: "DD/MM/YYYY", showWhen: { field: "reviewPeriod", value: "Custom Date Range" } },
        { id: "reportEndDate", label: "Custom finish date", type: "text", hideForPreRevenue: true, placeholder: "DD/MM/YYYY", showWhen: { field: "reviewPeriod", value: "Custom Date Range" } },
        ...
        { id: "secondaryOfferName", label: "Secondary Product Line / Offer", type: "text", hideForPreRevenue: true, placeholder: "Product / offer name" },
        { id: "secondaryOfferUrl", label: "Secondary product page URL", type: "url", hideForPreRevenue: true, placeholder: "https://example.com/product" },
        ...
        { id: "businessTypeId", label: "What kind of business or primary offer is this?", type: "select", required: true, options: window.GTM_TAXONOMY.BUSINESS_TYPE_OPTIONS, hint: "Choose the type of product, service, platform, or organization. How customers buy it is captured separately.", otherValue: "other_not_sure", otherLabel: "Briefly describe the business or offer type", quick: true },
        { id: "routeToMarket", label: "How do you expect customers to find and buy it?", type: "multiSelectDropdown", full: true, hint: "Select the intended route or routes. This answer carries into the pre-revenue segment and buying-path recommendations.", otherLabel: "Define another route to market", requireOther: true, options: ["Direct to consumer / ecommerce", "Direct B2B sales", "Retail / wholesale", "Distributor / reseller / partner", "Marketplace", "Self-serve / product-led", "Mixed", "Not sure yet", "Other"] },
        { id: "companyStage", label: "Company stage", type: "select", derivedForPreRevenue: true, preRevenueHint: "Set automatically from Pre-Revenue Validation.", options: ["Pre-revenue", "Pilot", "Early revenue", "Growth", "Scale", "Turnaround", "New market entry"], quick: true },
        ...
        { id: "teamSize", label: "Employee count / team size", type: "text", hideForPreRevenue: true },
        { id: "revenueRange", label: "Current annual revenue", type: "select", derivedForPreRevenue: true, preRevenueHint: "Set automatically from Pre-Revenue Validation.", options: ["Pre-revenue", "$0 - $1,000,000", "$1,000,001 - $5,000,000", "$5,000,001 - $10,000,000", "$10,000,001+"], quick: true },
        { id: "hasRecurringRevenue", label: "Revenue model", preRevenueLabel: "Expected revenue model", type: "select", options: ["Recurring Revenue Model", "Standard Revenue Model"], hint: "Recurring means time-based subscription, access, or retainer revenue. Standard means purchases, projects, transactions, or contracts that are not automatically recurring.", preRevenueHint: "Choose the model you expect to validate. Pre-revenue status does not determine whether future revenue will be recurring or standard." },
        { id: "monthlyRecurringRevenue", label: "Monthly recurring revenue (MRR)", type: "money", hideForPreRevenue: true, placeholder: "25,000", showWhen: { field: "hasRecurringRevenue", value: "Recurring Revenue Model" } },
        { id: "annualRecurringRevenue", label: "Annual recurring revenue (ARR)", type: "money", hideForPreRevenue: true, placeholder: "300,000", showWhen: { field: "hasRecurringRevenue", value: "Recurring Revenue Model" } },
        { id: "customerCount", label: "Current customer count", type: "text", hideForPreRevenue: true },
        { id: "averageDealSize", label: "Average deal size / order value / contract value", type: "money", hideForPreRevenue: true, quick: true },
        { id: "expectedFirstTransactionRange", label: "Expected first transaction or contract range", type: "text", preRevenueOnly: true, placeholder: "Optional: example $25-$50 order, $500 pilot, or $5,000 initial contract", hint: "Use this only when the expected commitment level will materially shape the validation test." },
        { id: "primarySalesMotion", label: "Primary sales motion today", type: "select", hideForPreRevenue: true, options: ["Self-serve", "Inside sales", "Field sales", "Founder-led", "Partner-led", "Enterprise sales", "Product-led", "Ecommerce", "Other"], quick: true },
        { id: "mainGrowthConstraint", label: "Main growth constraint today", type: "select", hideForPreRevenue: true, options: ["Strategic Planning - Lack of Documented Strategy/Tactics", "Strategic Planning - No clear documented vision", "Strategic Planning - Lack of realistic SWOT", "Technology - Outdated Tech", "Technology - Need for expensive systems", "Technology - Lack of AI Strategy", "Financial and Capital Constraints - Cash Flow Management", "Financial and Capital Constraints - Low or no Access to Credit", "Financial and Capital Constraints - Under Capitalization", "Talent and Leadership - Finding Qualified Workers", "Talent and Leadership - Founder Delegation", "Talent and Leadership - Workforce Demands", "Operational Infrastructure - Process Scalability", "Operational Infrastructure - Supply Chain Disruptions", "Operational Infrastructure - Organizational Complexity", "Market Dynamics and Product Fit - Lack of Strategic Planning", "Market Dynamics and Product Fit - Unclear Product-Market Fit", "Market Dynamics and Product Fit - Intense Competition", "Market Dynamics and Product Fit - Regulatory Hurdles", "Other"] },
        { id: "additionalGrowthConstraints", label: "Other / additional growth constraints", type: "repeatableList", hideForPreRevenue: true, minItems: 1, addLabel: "Add constraint", itemPlaceholder: "Enter one additional constraint" },
        { id: "researchNotes", label: "Research notes / ChatGPT paste-back", type: "textarea", full: true }
      ],
      tables: [
        {
          id: "publicPresence",
          hideForPreRevenue: true,
        ...
        {
          id: "preRevenueComparables",
          preRevenueOnly: true,
          title: "Comparable companies or products",
          hint: "Add up to three public examples that could help generate category, offer, buying-path, proof, and validation hypotheses. These are research inputs, not facts about your company.",
          layout: "cards",
          repeatable: true,
          minRows: 1,
          maxRows: 3,
          rowLabel: "Comparable",
          addLabel: "Add another comparable",
          columns: [
            { id: "name", label: "Company or product name", type: "text", group: "Comparable" },
            { id: "url", label: "Public URL", type: "url", group: "Comparable", placeholder: "https://example.com" },
            { id: "whyComparable", label: "Why is this a useful comparison?", type: "text", group: "Comparable", placeholder: "Example: similar buyer, product category, price point, or sales route" }
          ]
        }
      ]
    },
      ...
      content: [
        ...
        },
        {
          ...
          fields: [
            ...
            { id: "preFirstCustomerTypes", label: "Which paying customer or buying-account types could realistically be first?", type: "multiSelectDropdown", full: true, hint: "Answer for the party that would buy, approve, carry, or resell the offer. For B2B, wholesale, or channel sales, name the business account (for example, Pilates studios), not only the person who ultimately uses the product.", otherLabel: "Define other first customer or account type", requireOther: true, options: PRE_REVENUE_CUSTOMER_TYPE_OPTIONS },
          ...
          tables: [
            {
              ...
              columns: [
                { id: "segmentName", label: "Which paying customer or buying account are you narrowing into this candidate segment?", type: "select", group: "Segment", hint: "Follow the buying path. If a business buys, carries, or resells the product, name that business type here (for example, Pilates studios). Describe the end user separately in the use-case and buyer-role questions.", optionsFromMultiselect: "preFirstCustomerTypes", otherLabel: "Define a more specific customer or account segment", requireOther: true, options: ["End users with a specific use case", "Problem-aware buyers", "Hobbyists or enthusiasts", "Small businesses or teams", "Channel buyers or partners", "Marketplace participants", "I don't know yet", "Other"] },
                ...
                { id: "description", label: "Which observable traits help identify this customer or buying account?", type: "multiSelectDropdown", group: "Segment", full: true, hint: "Choose traits that help you find the actual buyer. For B2B or channel sales, prioritize account type, industry, location, size or stage, and buying triggers. Use lifestyle or personal-use traits only when the end user is also the buyer.", otherLabel: "Define other observable trait", requireOther: true, options: ["Specific use case, job, task, or occasion", "Specific product, service, software, or solution category", "Specific lifestyle, workflow, identity, or goal", "Specific geography", "Specific price point or budget range", "Specific age, life stage, company stage, or maturity level", "Specific community, industry, role, or interest group", "Specific buyer type, account type, or channel type", "Specific buying window, season, deadline, or trigger", "Specific channel, marketplace, platform, or source", "Other"] },
                ...
                { id: "likelyBuyerPath", label: "Confirm the buying path for this segment", type: "select", group: "Segment", hint: "The tool prefills this from the earlier route-to-market answer. Change it only when this segment follows a different path.", options: ["", "Direct to consumer / end user", "Retail, wholesale, distributor, or marketplace", "Corporate or team purchase", "Mixed or not sure yet"] },
                ...
                { id: "reachability", label: "Legacy reach path", type: "multiSelectDropdown", group: "Reach and credibility", full: true, omitFromIntake: true, otherLabel: "Define other reach path", requireOther: true, options: PRE_REVENUE_REACHABILITY_OPTIONS },
                { id: "reachabilityUnknown", label: "Legacy unknown reach path", type: "text", group: "Reach and credibility", full: true, omitFromIntake: true },
                { id: "firstConversationAccess", label: "How could you reach the first 10 people or buyers for validation?", type: "multiSelectDropdown", group: "Reach and credibility", full: true, otherLabel: "Define another first-conversation source", requireOther: true, options: PRE_REVENUE_REACHABILITY_OPTIONS },
                { id: "firstConversationAccessUnknown", label: "If you do not know yet, where could you find 10 names, profiles, accounts, groups, communities, or channels to test?", type: "text", group: "Reach and credibility", full: true, showWhen: { field: "firstConversationAccess", contains: "I don't know yet" }, placeholder: "Example: founder contacts, local businesses, communities, social search, marketplace sellers, trade-show lists, LinkedIn, or an association directory." },
                { id: "repeatableReach", label: "After the first test, what could become a repeatable source of similar buyers?", type: "multiSelectDropdown", group: "Reach and credibility", full: true, otherLabel: "Define another repeatable source", requireOther: true, options: ["Targeted outbound list", "Search / SEO", "Paid social or paid search", "Organic social or content", "Community or audience", "Retail / wholesale outreach", "Distributor / reseller / partner network", "Marketplace discovery", "Events / trade shows / associations", "Customer referrals", "Founder or team network", "Not sure yet", "Other"] },
                ...
                { id: "validationPathDtc", label: "Legacy DTC validation path", type: "multiSelectDropdown", group: "Validation", full: true, omitFromIntake: true, options: PRE_REVENUE_DTC_VALIDATION_PATH_OPTIONS },
                { id: "validationPathDtcUnknown", label: "Legacy unknown DTC validation path", type: "multiSelectDropdown", group: "Validation", full: true, omitFromIntake: true, options: [] },
                { id: "validationPathChannel", label: "Legacy channel validation path", type: "multiSelectDropdown", group: "Validation", full: true, omitFromIntake: true, options: PRE_REVENUE_CHANNEL_VALIDATION_PATH_OPTIONS },
                { id: "validationPathChannelUnknown", label: "Legacy unknown channel validation path", type: "multiSelectDropdown", group: "Validation", full: true, omitFromIntake: true, options: [] },
                { id: "validationRecommendationReview", label: "Use this recommended 30-day test?", type: "select", group: "Validation", full: true, options: [{ value: "Use the recommended test", label: "Use this test" }, { value: "I want to revise the recommended test", label: "Revise this test" }, "Not sure yet"], hint: "The proposed test above is generated from this segment, buying path, and first-conversation access. Choose Revise this test to add a required change." },
                { id: "validationRecommendationRevision", label: "What should change about the recommended test?", type: "textarea", group: "Validation", full: true, showWhen: { field: "validationRecommendationReview", value: "I want to revise the recommended test" }, placeholder: "Describe the access, timing, commitment, channel, or operating constraint the recommendation should account for." },
                ...
                { id: "evidenceNotes", label: "Evidence details or source (optional)", type: "textarea", group: "Assumptions vs. Evidence", full: true, hint: "Add factual details that support the evidence selected above: who provided the feedback, how many conversations or responses you have, what they requested or did, and when it happened. The tool uses this in the plan's Evidence Available section, the Persona Brief, and the evidence-strength assessment. Do not add assumptions or repeat the dropdown selections; leave this blank when there is no additional evidence.", placeholder: "Example: Spoke with 4 retail buyers in July; 3 requested samples and 1 asked for wholesale pricing." },
                { id: "buyingRequirements", label: "Legacy buying requirements", type: "multiSelectDropdown", group: "What must be true", full: true, omitFromIntake: true, options: PRE_REVENUE_BUYER_ROLE_OPTIONS },
                { id: "implementationRequirements", label: "Legacy implementation requirements", type: "multiSelectDropdown", group: "What must be true", full: true, omitFromIntake: true, options: [] },
                { id: "riskRequirementsDtc", label: "Legacy DTC risk requirements", type: "multiSelectDropdown", group: "What must be true", full: true, omitFromIntake: true, options: PRE_REVENUE_DTC_BUYER_WORRY_OPTIONS },
                { id: "riskRequirementsDtcUnknown", label: "Legacy unknown DTC risk", type: "multiSelectDropdown", group: "What must be true", full: true, omitFromIntake: true, options: [] },
                { id: "riskRequirementsChannel", label: "Legacy channel risk requirements", type: "multiSelectDropdown", group: "What must be true", full: true, omitFromIntake: true, options: PRE_REVENUE_CHANNEL_BUYER_WORRY_OPTIONS },
                { id: "riskRequirementsChannelUnknown", label: "Legacy unknown channel risk", type: "multiSelectDropdown", group: "What must be true", full: true, omitFromIntake: true, options: [] },
                { id: "timingRequirements", label: "Legacy timing requirements", type: "multiSelectDropdown", group: "What must be true", full: true, omitFromIntake: true, options: PRE_REVENUE_WHY_NOW_OPTIONS },
                { id: "successRequirements", label: "Legacy success requirements", type: "multiSelectDropdown", group: "What must be true", full: true, omitFromIntake: true, options: [] },
                { id: "successRequirementsUnknown", label: "Legacy unknown success requirement", type: "multiSelectDropdown", group: "What must be true", full: true, omitFromIntake: true, options: [] },
                { id: "validationChecklistMissing", label: "Is anything important missing from this checklist? (optional)", type: "textarea", group: "Validation checklist", full: true, hint: "Add only a missing decision role, operating requirement, risk, timing constraint, or success signal. Your addition will appear in the plan's What to Validate Before Scaling checklist. Leave this blank if the generated checklist is complete.", placeholder: "Example: Confirm whether retailers require specific packaging, margins, or minimum order quantities." },
        ...
        {
          title: "Step 3: Review the Recommendation",
          fields: [
            { id: "prePrimaryHypothesis", label: "Which segment should the plan lead with?", type: "select", dynamicOptionsFrom: "preCustomerHypotheses", options: ["Not sure yet"], hint: "Choose Not sure yet to use the highest-ranked recommendation. If you choose another segment, the plan will lead with your override and flag any score conflict." },
            { id: "preHypothesisReason", label: "Why are you selecting or overriding this segment?", type: "multiSelectDropdown", full: true, otherLabel: "Define another reason", requireOther: true, options: ["Easiest to reach", "Strongest problem fit", "Fastest validation path", "Lowest cost to test", "Best founder credibility", "Best early revenue potential", "Best proof opportunity", "Best DTC demand signal", "Best wholesale / retail path", "Lowest delivery risk", "Most urgent timing", "Not sure yet", "Other"] },
            { id: "preHypothesisNotes", label: "What context should the plan preserve about this choice?", type: "textarea", full: true }
          ]
        }
      ]
    },
          ...
          tables: [
            {
              ...
              columns: [
                ...
                { id: "channelSource", label: "Where would the opportunity come from? (channel / source)", type: "multiSelectDropdown", hint: "Select every channel or source that applies to this revenue motion.", otherLabel: "Define other channel or source", requireOther: true, options: ["Inbound website leads", "Direct outbound email", "Cold calling", "LinkedIn / social selling", "Social media posts", "Social media ads", "Website conversion / booking flow", "Content / SEO", "Paid search / paid social", "Events / webinars / communities", "Network referrals", "Customer referrals", "Trade shows", "Partners / affiliates / resellers", "Marketplaces / app stores / directories", "Current customer expansion / upsell", "Customer success outreach", "Product usage / product-led", "Retail / field / local selling", "Other", "Not sure yet"] },
