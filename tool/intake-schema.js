          ...
          tables: [
            {
              ...
              columns: [
                ...
                { id: "specificUseCaseDefinition", label: "Briefly define the specific use case, job, task, or occasion", type: "textarea", group: "Segment", full: true, required: true, showWhen: { field: "description", contains: "Specific use case, job, task, or occasion" }, hint: "Describe who is in the situation, what they are trying to do, and what better outcome they want. This becomes the plain-language use case in the ICP Brief.", placeholder: "Example: Fishermen who want to keep essential gear in an easily accessible place while actively fishing." },
