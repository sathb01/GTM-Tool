          ...
          tables: [
            {
              ...
              columns: [
                ...
                { id: "validationChecklistReview", label: "Review the generated validation checklist", type: "select", group: "Validation checklist", full: true, options: ["Use the generated checklist", "The checklist is missing something important", "Not sure yet"], hint: "The report generates decision roles, operating requirements, likely risks, timing, and success signals from the answers above." },
                { id: "validationChecklistMissing", label: "What important requirement is missing?", type: "textarea", group: "Validation checklist", full: true, showWhen: { field: "validationChecklistReview", value: "The checklist is missing something important" }, placeholder: "Add only the missing decision role, operational requirement, risk, timing constraint, or success signal." },
